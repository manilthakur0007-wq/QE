...
A modular, configurable Python research and paper-trading engine for equities. I use
this repo to run reproducible backtests and safe Alpaca paper-execution demos.

Topics: quantitative-trading, backtesting, paper-trading, portfolio-management, python
